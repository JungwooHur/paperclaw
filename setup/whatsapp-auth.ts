...
<html><head><title>PaperClaw - WhatsApp Auth</title>
...
<script>
  var startKey = 'paperclaw_qr_start';
...
<html><head><title>PaperClaw - Connected!</title>
<style>
...
<script>localStorage.removeItem('paperclaw_qr_start');</script>
</body></html>`;
