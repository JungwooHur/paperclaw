...
PaperClaw gives you the core functionality without that mess.
...
- Custom `paperclaw` MCP server (inside container) provides scheduling tools
...
**PaperClaw** - A reference to Clawdbot (now OpenClaw).
